...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); //extends the map bounds to include current location
...
var stripe = Stripe('pk_test_51HJilKKYy7eeflMRwmnCfaGLEv6JjUOzGzoQt9TpXxpM78mgwfp2oefdLUhNVqlvYPPece52bsX8UuACARgjwkyd00o09aJZZT');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"forgotPasswor.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgPass = void 0;
...
function () {
  ...
  return function forgPass(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.forgPass = forgPass;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, email, password, confirmPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Sign Up successfull. Please Login again .');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
function () {
  ...
  return function reset(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(tourId, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Review submitted.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function reviewSys(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.reviewSys = reviewSys;
...
var _forgotPasswor = require("./forgotPasswor");
...
var resetForm = document.querySelector('.form--resetPassword');
var logOutBtn = document.querySelector('.nav__el--logout');
var signupForm = document.querySelector('.form--signup');
var userDataForm = document.querySelector('.form-user-data');
var forgotDataForm = document.querySelector('.form--forgotPassword');
...
if (reviewBtn) reviewBtn.addEventListener('click', function (e) {
  ...
  (0, _review.reviewSys)(tourId, review, rating);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              password = document.getElementById('password').value;
              confirmPassword = document.getElementById('password-confirm').value; //console.log(name,email,password,confirmPassword);
...
if (forgotDataForm) {
  forgotDataForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              email = document.getElementById('email').value;
              _context3.next = 4;
              return (0, _forgotPasswor.forgPass)(email);
...
if (resetForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee4(e) {
      var password, confirmPassword, token;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 7;
              return (0, _resetPassword.reset)(password, confirmPassword, token);
